...
export default async function NewQuotePage() {
  ...
  return (
    <main className="max-w-screen-2xl mx-auto px-6 py-16">
      <p className="text-2xs uppercase tracking-widest text-muted mb-3">Cotizaciones</p>
      <h1 className="font-display text-4xl text-ink font-light mb-12">Nueva cotización</h1>
      <DocForm kind="quote" clients={(clients ?? []) as Client[]} brands={(brands ?? []) as Brand[]} onSubmit={submit} />
    </main>
  )
}
